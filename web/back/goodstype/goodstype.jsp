    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#batchDel").click(function () {
                ...
                obj.ids = idList;
                //使用Ajax进行数据交换
                $.post("/goodstypebatchdel",obj,function (data) {
                    //页面刷新
                    location.reload();
                })
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><a href="/goodstypeadd"><span><img src="images/t01.png" /></span>添加</a></li>
        ...
        <tbody>
                ...
                <c:forEach items="${page.list}" var="goodsType">
                    <tr>
                        ...
                        <td>
                            <a href="/goodstypeupdate?id=${goodsType.id}">编辑</a>
                            <a href="/goodstypedelete?delid=${goodsType.id}"}>删除</a>
                        </td>
                    </tr>
                </c:forEach>
        </tbody>
