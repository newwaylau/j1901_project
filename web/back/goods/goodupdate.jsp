...
<body>
    ...
    <form method="post" action="/goodsinfoupdate" enctype="multipart/form-data">
	    ...
	    <li><label>商品原价</label><input name="goods_price" type="text" class="dfinput" value="${goodsInfo.goods_price}"/><i>标题不能超过30个字符</i></li>
	    <li><label>商品折扣价</label><input name="goods_price_off" type="text" class="dfinput" value="${goodsInfo.goods_price_off}"/><i>标题不能超过30个字符</i></li>
	    <li><label>商品图片</label><input name="goods_pic" type="file" id="uploadFile" /><i>标题不能超过30个字符</i></li>
			<<img src="images/${goodsInfo.goods_pic}" id="goods_pic"/><br/>
